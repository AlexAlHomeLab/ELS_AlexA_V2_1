...
Если движение еще не завершилось а РГИ сменил направление на N импульсов (случайный поворот, дребезг) то игнорируем, если более чем N то текущее движение немедленно полностью останавливается.
...
Нельзя дельть рывки и пропуски шагов
